...
对于 PDF 有什么用这个问题，我们最好结合当下要去解决的问题，或者要学习的内容去了解。比如说，笔者最近正在学习路径追踪中 [Monte Carlo](https://yang-zhihang.github.io/posts/graphics/monte-carlo/) 积分那一块的内容，那么笔者就应该结合这部分去了解 PDF 在其中扮演了一个怎样的角色。
...
此处我们只讲述大致的步骤，具体实现可以参考笔者的开源项目👉[Yang-ZhiHang/rs-path-tracer](https://github.com/Yang-ZhiHang/rs-path-tracer)。
...
::github{repo="yang-zhihang/rs-path-tracer"}
