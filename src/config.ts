...
export const siteConfig: SiteConfig = {
	title: "ZamYang's Blog",
	subtitle: "Patience is key in life, but also passion.",
	lang: "zh_CN",
	themeColor: {
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/Yang-ZhiHang", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	name: "ZamYang",
	bio: "Patience is key in life, but also passion.",
	links: [
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/Yang-ZhiHang",
		},
	],
};
